 ...
 * @author Nash
 */
public class PPNanoStitcher_Configurator extends JFrame {
    ...
    public PPNanoStitcher_Parameters.LocalizationPara LocPara;

    public String RerendLocDataPath = null;
    public int RerendMode = 0; // 0: single file, 1: dir

    public PNanoStitcher_ PNanoStitcherRender;

    public int DriftCorrEnableI = 1;
    public int DriftCorrGroupFrameNum = 1000;

    final String LocParafileName = "PNanoStitcher_Configurator.PNanoStitcher\\PNanoStitcher_IJ_para.properties";
    volatile public String ResultsFilePath = "D:\\PNanoStitcher.txt";

    public PNanoStitcher_Configurator() {
        System.out.println("PNanoStitcher_Configurator has para");
        initComponents();

        LocPara = new PNanoStitcher_Parameters.LocalizationPara();

        iniContant();
    }

    public PNanoStitcher_Configurator(PNanoStitcher_ fa_PNanoStitcherRender) {
        System.out.println("PNanoStitcher_Configurator no para");
        initComponents();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("PNanoStitcher");

        PNanoStitcherRender = fa_PNanoStitcherRender;
    ...
    private void jButton_Render(ActionEvent e) {
        ...
        try {
            PNanoStitcherRender.StartRerend();

        } catch (Exception ex) {
            System.out.println("PNanoStitcherRender has error");
        }
    ...
    public PNanoStitcher_Parameters.LocalizationPara GetLocalizationPara()
    {
    ...
    void SendLocalizationPara()
    {
        ...
        PNanoStitcher_.lm_SetLocPara(LocPara.Kadc,LocPara.Offset,LocPara.QE,LocPara.RegionSize,LocPara.LocType, LocPara.MultiEmitterFitEn, LocPara.WLEEn, LocPara.ConsecutiveFitEn, LocPara.ConsecFilterRadius, LocPara.RawImgPixelSize,LocPara.RenderingPixelZoom,LocPara.SNR_th);

        PNanoStitcher_.lm_SetStatInfSelection(LocPara.StatDispSel, LocPara.SpatialResolutionEn);
        System.out.println(LocPara.StatDispSel + " " + LocPara.SpatialResolutionEn);
        PNanoStitcher_.lm_SetSpatialResolutionInf(LocPara.StructureSize2D);
    ...
    public void iniContant(){
        ...
        {
            ResultsFilePath = PNanoStitcher_Parameters.SelectDisk();
        }
    ...
    public String GetParaFileSavePath()
    {
        ...
        String ParaFilePath = PNanoStitcher_Parameters.SelectDisk();
...
//        datasetDirPath
        ...
        PNanoStitcher_.lm_CombineLocarryForImagej(Image_Length, Image_Width, DisPath, newPicPath, datasetDirPath);
...
//        new PNanoStitcher_Configurator().setVisible(true);
//    }
