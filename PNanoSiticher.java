...
public class PNanoStitcher_ implements PlugInFilter {
    ...
    public PNanoStitcher_Configurator MyConfigurator;
    ...
    public int setup(String string, ImagePlus ip) {
        System.out.println("PNanoStitcher_ setup");
        // initial
        System.loadLibrary("PNanoStitcher_render");
        CurImagePlus=ip;
        ...
        MyConfigurator=new PNanoStitcher_Configurator(this);
        MyConfigurator.setVisible(true);

        hotCM = PNanoStitcher_Parameters.GetHotColorModel();
    ...
    public class RerendThread_Main extends Thread
    {
        ...
        public void run()
        {
            ...
            try {
                ...
                {
                    ArrayList<String> FilesList = PNanoStitcher_Parameters.ListTxtFiles(MyConfigurator.RerendLocDataPath);
...
//        PNanoStitcher_ PNanoStitcherRender = new PNanoStitcher_();
//        //PNanoStitcherRender.getClass().getClassLoader().getResource("");
//    }
